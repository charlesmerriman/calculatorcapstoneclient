...
export const Register: React.FC = () => {
	...
	const handleRegisterSubmit = async (data: RegisterFormData): Promise<void> => {
		try {
			/**
			 * TYPESCRIPT CONCEPT: Intentionally Unused Destructured Variables
			 *
			 * We destructure confirmPassword out so it doesn't get sent to
			 * the server (only the remaining fields in registerData are sent).
			 * The underscore prefix tells both humans and the linter
			 * "this is intentionally unused."
			 *
			 * With `noUnusedLocals: true` (part of strict mode), unprefixed
